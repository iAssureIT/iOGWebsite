                    ...
                    <div className="col-md-6">
                        <div className="row">
                            ...
                            <div className="col-md-3 col-sm-3 col-xs-12">
                                <span className="el-icon2x"><img src="images/placeholder.png"/></span>
                            ...
                            <div className="col-md-3 col-sm-3 col-xs-6">
                                <span className="el-icon2x"><img src="images/megaphone.png"/></span>
                                <h5 className="color-light"><strong>Phone</strong></h5>
                                <p className="color-light contactp">123-456-789</p>
                            </div>
                            
                            <div className="col-md-3 col-sm-3 col-xs-6">
                               <span className="el-icon2x"><img src="images/message.png"/></span>
                    ...
                    <div className="col-md-6">
                        <div className="contact contact-us-one">
                            ...
                            <form name="contactform" id="contactForm" method="post" action="assets/php/send.php" className="positioned">
                                ...
                                <div className="form-group col-md-12 col-sm-12 col-xs-12">
                                    <button type="submit" name="sendMessage" id="sendMessage" className=" contactbutton-md contactbutton-block contactbutton-grad-stellar">Send Message</button>
                                </div>
