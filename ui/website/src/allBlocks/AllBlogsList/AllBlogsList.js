	...
	return (
		...
		<div>
			<div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 container-fluid AllBlogsBox" style={{padding:"0px"}}>
			    ...
			    <div className="col-lg-offset-1 col-md-offset-1 col-lg-10 col-md-10 col-sm-10 col-xs-10 ">
			       <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12"style={{paddingLeft:"78px"}}>
		          {
