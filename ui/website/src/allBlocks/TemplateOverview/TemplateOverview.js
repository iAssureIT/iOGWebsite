        ...
        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               ...
               <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div className="col-lg-6 col-md col-sm-12 col-xs">
                  <img src="/images/block1.png" className="col-lg-offset-4 B2T_overviewTxt"/>
                </div>
               </div>
              </div> 
        </div>
