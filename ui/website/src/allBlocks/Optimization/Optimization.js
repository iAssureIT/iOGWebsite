                                  ...
                                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div className="bluetext  optimization_paraaa-top">{data.optimizationsuubTitle}</div>
                                            <p className="optimization_line_paraaaa">{data.optimizationtext}
                                            </p> 
                                            <p className="optimization_line_paraaaa1">{data.optimizationtext1}
                                            </p> 
                                         </div>
                                        </div>
                                       </div>
