                ...
                <div className="">
                    <div className="col-md-3 col-sm-6 col-xs-12  pricehover-float">
                        <div className="">
                            ...
                            <div className="price-badge1 bgiogyellow bg-grad-blood-mary">Geology & Geophysics</div>
                    ...
                    <div className="col-md-3 col-sm-6 col-xs-12 pricehover-float">
                        <div className="">
                             <div className="price price-three">
                            <div className="price-badge1 bgiogyellow bg-grad-blood-mary">Reservoir Management</div>
                            {/*<div className="price-header">
                    ...
                    <div className="col-md-3 col-sm-6 col-xs-12 pricehover-float">
                        <div className="">
                            <div className="price price-three">
                            <div className="price-badge1 bgiogyellow bg-grad-blood-mary">Well & Drilling</div>
                           {/* <div className="price-header">
                    ...
                    <div className="col-md-3 col-sm-6 col-xs-12  pricehover-float">
                        <div className="">
                            <div className="price price-three">
                            <div className="price-badge1 bgiogyellow bg-grad-blood-mary">Production Management</div>
                            {/*<div className="price-header">
