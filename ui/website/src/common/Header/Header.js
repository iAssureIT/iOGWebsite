           ...
           <div class="topnav" id="myTopnav">
            ...
            <div class="dropdown ">
              <button class="dropbtn"><a href="/masterpage/newexpertise" className={this.state.pageUrl == "/masterpage/newexpertise" ||  this.state.pageUrl == "/masterpage/supply-&-distribution" ||  this.state.pageUrl == "/masterpage/planning-&-scheduling" ||  this.state.pageUrl == "/masterpage/manufacturing-exec-system"   
                ||  this.state.pageUrl == "/masterpage/digital-services" ||  this.state.pageUrl == "/masterpage/simulation-and-modeling"  ||  this.state.pageUrl == "/masterpage/health-safety-environment" ||  this.state.pageUrl == "/masterpage/energy-management." ||  this.state.pageUrl == "/masterpage/asset-management"  
                ||  this.state.pageUrl == "/masterpage/other-services"  ||  this.state.pageUrl == "/masterpage/production-plannning" ||  this.state.pageUrl == "/masterpage/refinery-scheduling" ||  this.state.pageUrl == "/masterpage/lp-utilities" ||  this.state.pageUrl == "/masterpage/retro-analysis" ||  this.state.pageUrl == "/masterpage/lp-configuration"
                ||  this.state.pageUrl == "/masterpage/production-accounting"  ||  this.state.pageUrl == "/masterpage/real-time-data-historian" ||  this.state.pageUrl == "/masterpage/corporate-dashboard" ||  this.state.pageUrl == "/masterpage/operation-logbook" ||  this.state.pageUrl == "/masterpage/oil-movement"   
                ||  this.state.pageUrl == "/masterpage/demand-management"  ||  this.state.pageUrl == "/masterpage/invetory-management" ||  this.state.pageUrl == "/masterpage/distribution-planning" ||  this.state.pageUrl == "/masterpage/retail-automation" ||  this.state.pageUrl == "/masterpage/digital-transformation"  
                ||  this.state.pageUrl == "/masterpage/application-support"  ||  this.state.pageUrl == "/masterpage/application-integration" ||  this.state.pageUrl == "/masterpage/visualization-&-dashboards" ||  this.state.pageUrl == "/masterpage/industries-v4" ||  this.state.pageUrl == "/masterpage/steady-state-simulation" 
                ||  this.state.pageUrl == "/masterpage/dynamic-simulation"  ||  this.state.pageUrl == "/masterpage/operator-training" ||  this.state.pageUrl == "/masterpage/occupational-health-management" ||  this.state.pageUrl == "/masterpage/process-safety-management" ||  this.state.pageUrl == "/masterpage/environment-management" 
                ||  this.state.pageUrl == "/masterpage/apc-services"  ||  this.state.pageUrl == "/masterpage/etrm" ||  this.state.pageUrl == "/masterpage/utility-network-optimization" ||  this.state.pageUrl == "/masterpage/equipment-monitoring" ||  this.state.pageUrl == "/masterpage/energy-accounting" 
                ||  this.state.pageUrl == "/masterpage/asset-lifecycle"  ||  this.state.pageUrl == "/masterpage/asset-criticality-analysis" ||  this.state.pageUrl == "/masterpage/asset-strategy-management" ||  this.state.pageUrl == "/masterpage/inspection-&-calibration" 
                  ? "Currentactivetab NopaddingToA" : "NopaddingToA" }>EXPERTISE</a>
                 <i className={this.state.pageUrl == "/masterpage/newexpertise" ||  this.state.pageUrl == "/masterpage/supply-&-distribution" ||  this.state.pageUrl == "/masterpage/planning-&-scheduling" ||  this.state.pageUrl == "/masterpage/manufacturing-exec-system"   
                ||  this.state.pageUrl == "/masterpage/digital-services" ||  this.state.pageUrl == "/masterpage/simulation-and-modeling"  ||  this.state.pageUrl == "/masterpage/health-safety-environment" ||  this.state.pageUrl == "/masterpage/energy-management." ||  this.state.pageUrl == "/masterpage/asset-management"  
                ||  this.state.pageUrl == "/masterpage/other-services"  ||  this.state.pageUrl == "/masterpage/production-plannning" ||  this.state.pageUrl == "/masterpage/refinery-scheduling" ||  this.state.pageUrl == "/masterpage/lp-utilities" ||  this.state.pageUrl == "/masterpage/retro-analysis" ||  this.state.pageUrl == "/masterpage/lp-configuration"
                ||  this.state.pageUrl == "/masterpage/production-accounting"  ||  this.state.pageUrl == "/masterpage/real-time-data-historian" ||  this.state.pageUrl == "/masterpage/corporate-dashboard" ||  this.state.pageUrl == "/masterpage/operation-logbook" ||  this.state.pageUrl == "/masterpage/oil-movement"   
                ||  this.state.pageUrl == "/masterpage/demand-management"  ||  this.state.pageUrl == "/masterpage/invetory-management" ||  this.state.pageUrl == "/masterpage/distribution-planning" ||  this.state.pageUrl == "/masterpage/retail-automation" ||  this.state.pageUrl == "/masterpage/digital-transformation"  
                ...
                ||  this.state.pageUrl == "/masterpage/dynamic-simulation"  ||  this.state.pageUrl == "/masterpage/operator-training" ||  this.state.pageUrl == "/masterpage/occupational-health-management" ||  this.state.pageUrl == "/masterpage/process-safety-management" ||  this.state.pageUrl == "/masterpage/environment-management" 
                ||  this.state.pageUrl == "/masterpage/apc-services"  ||  this.state.pageUrl == "/masterpage/etrm" ||  this.state.pageUrl == "/masterpage/utility-network-optimization" ||  this.state.pageUrl == "/masterpage/equipment-monitoring" ||  this.state.pageUrl == "/masterpage/energy-accounting" 
                ||  this.state.pageUrl == "/masterpage/asset-lifecycle"  ||  this.state.pageUrl == "/masterpage/asset-criticality-analysis" ||  this.state.pageUrl == "/masterpage/asset-strategy-management" ||  this.state.pageUrl == "/masterpage/inspection-&-calibration"  ? "Currentactivetab NopaddingToA fa fa-angle-down Headerdownarraow":"NopaddingToA fa fa-angle-down Headerdownarraow"}></i>
              </button>
             ...
             <div class="dropdown">
              <button class="dropbtn"><a href="/masterpage/newindustries"className={this.state.pageUrl == "/masterpage/newindustries" ||  this.state.pageUrl == "/masterpage/refinery" ||  this.state.pageUrl == "/masterpage/petrochemical"  ||  this.state.pageUrl == "/masterpage/chemicals" ||  this.state.pageUrl == "/masterpage/gas-processing" ||  this.state.pageUrl == "/masterpage/oil-&-gas-e-&-p"  
                ||  this.state.pageUrl == "/masterpage/well-drilling" ||  this.state.pageUrl == "/masterpage/reservior-management" ||  this.state.pageUrl == "/masterpage/geology-geophysics" ||  this.state.pageUrl == "/masterpage/supply-chain-management"
/*                ||  this.state.pageUrl == "/masterpage/production-management" ||  this.state.pageUrl == "/masterpage/operation-logbook" ||  this.state.pageUrl == "/masterpage/oil-movement"   
                ||  this.state.pageUrl == "/masterpage/demand-management"  ||  this.state.pageUrl == "/masterpage/invetory-management" ||  this.state.pageUrl == "/masterpage/distribution-planning" ||  this.state.pageUrl == "/masterpage/retail-automation" ||  this.state.pageUrl == "/masterpage/digital-transformation"  
                ||  this.state.pageUrl == "/masterpage/application-support"  ||  this.state.pageUrl == "/masterpage/application-integration" ||  this.state.pageUrl == "/masterpage/visualization-&-dashboards" ||  this.state.pageUrl == "/masterpage/industries-v4" ||  this.state.pageUrl == "/masterpage/steady-state-simulation" 
                ||  this.state.pageUrl == "/masterpage/dynamic-simulation"  ||  this.state.pageUrl == "/masterpage/operator-training" ||  this.state.pageUrl == "/masterpage/occupational-health-management" ||  this.state.pageUrl == "/masterpage/process-safety-management" ||  this.state.pageUrl == "/masterpage/environment-management" 
                ||  this.state.pageUrl == "/masterpage/apc-services"  ||  this.state.pageUrl == "/masterpage/etrm" ||  this.state.pageUrl == "/masterpage/utility-network-optimization" ||  this.state.pageUrl == "/masterpage/equipment-monitoring" ||  this.state.pageUrl == "/masterpage/energy-accounting" */
                       ? "Currentactivetab NopaddingToA" : "NopaddingToA" }>INDUSTRIES</a> 
                 <i className={this.state.pageUrl == "/masterpage/newindustries" ||  this.state.pageUrl == "/masterpage/refinery" ||  this.state.pageUrl == "/masterpage/petrochemical"  ||  this.state.pageUrl == "/masterpage/chemicals" ||  this.state.pageUrl == "/masterpage/gas-processing" ||  this.state.pageUrl == "/masterpage/oil-&-gas-e-&-p"  
                ||  this.state.pageUrl == "/masterpage/well-drilling" ||  this.state.pageUrl == "/masterpage/reservior-management" ||  this.state.pageUrl == "/masterpage/geology-geophysics" ||  this.state.pageUrl == "/masterpage/supply-chain-management" ? "Currentactivetab NopaddingToA fa fa-angle-down Headerdownarraow":"NopaddingToA fa fa-angle-down Headerdownarraow"}></i>
              </button>
              <div class="dropdown-content normaldropdown dropdownintab" style={{position:"fixed"}}>
