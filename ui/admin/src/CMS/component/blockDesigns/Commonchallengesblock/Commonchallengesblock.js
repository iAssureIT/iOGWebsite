...
import './Commonchallengesblock.css';

export default class Commonchallengesblock extends Component {
        constructor(props) {
    super(props);
    this.state = {
      blocks:"",
                                  ...
                                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <p className="challenges_line_subheadd ">{this.state.blocks.blockTitle}</p>
                                            <p className="challenges_line_paraaaa">{this.state.blocks.blockSubTitle}
                                            <br></br>
                                            </p> 
                                           </div>
                       ...
                       return ( 
                        <div key={index} className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                  <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                          <p className="challenges_line_paraaaa2">
                                        {/*data.challengestext2*/}
                                        <div dangerouslySetInnerHTML={ { __html: this.state.blocks.blockDescription } }></div>
                                          </p>
                                       </div>
                                      </div>
