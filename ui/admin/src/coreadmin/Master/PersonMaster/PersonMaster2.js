                                                                                            ...
                                                                                            <div className="form-margin col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left NOpadding-right">
                                                                                                ...
                                                                                                <div className=" col-lg-4 col-md-4 col-sm-12 col-xs-12 driver  person">
                                                                                                    <div id="documentValidFrom">
                                                                                                        <label className="labelform col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding-left">Valid From Date <i className="astrick"></i>
                                                                                                        </label>
                                                                                                            ...
                                                                                                            this.state["DocProof"+i].map((data, i) => {
                                                                                                                ...
                                                                                                                return (
                                                                                                                    <div key={i} className="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                                                                                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                                                                                                            <label className="labelform deletelogo col-lg-12 col-md-12 col-sm-12 col-xs-12" id={data} index={i} token={doc.documentName} name={"DocProof"+i}  onClick={this.deleteDoc.bind(this)}>x</label>
                                                                                                                ...
                                                                                                                this.state["docproofimg"+i].map((data, i) => {
                                                                                                                    ...
                                                                                                                    return (
                                                                                                                        <div key={i} className="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                                                                                        {
                                                                                                                            data !== null ?
                                                                                                                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 NOpadding marginsBottom" id="hide">
                                                                                                                                <label className="labelform deletelogo col-lg-12 col-md-12 col-sm-12 col-xs-12" id={data} index={i} token={doc.documentName} name={"docproofimg"+i} onClick={this.deleteDoc.bind(this,i)}>x</label>
